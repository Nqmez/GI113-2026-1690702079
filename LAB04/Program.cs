...
Console.WriteLine("Choose difficulity (1-3): ");
bool difficulityOk = int.TryParse(Console.ReadLine(), out int difficulity);
Console.WriteLine($"Valid input: {difficulityOk}");
Console.WriteLine($"Difficulity set to {difficulity}");
